...
class annual_report(models.Model):
	...
	front_exterior_picture = models.ImageField(upload_to=content_file_name, blank=True)
	back_exterior_picture = models.ImageField(upload_to=content_file_name, blank=True)
	kitchen_picture = models.ImageField(upload_to=content_file_name, blank=True)
	bathroom_picture = models.ImageField(upload_to=content_file_name, blank=True)
